...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _index = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar RenderInStack = function (_Component) {\n    _inherits(RenderInStack, _Component);\n\n    function RenderInStack(props) {\n        _classCallCheck(this, RenderInStack);\n\n        var _this = _possibleConstructorReturn(this, (RenderInStack.__proto__ || Object.getPrototypeOf(RenderInStack)).call(this, props));\n\n        var id = props.id,\n            _props$instanceId = props.instanceId,\n            instanceId = _props$instanceId === undefined ? _index.DEFAULT_INSTANCE_ID : _props$instanceId;\n\n        if (!_index.globalContext[instanceId]) {\n            _index.globalContext[instanceId] = {};\n        }\n        _index.globalContext[instanceId][id] = props.children;\n        return _this;\n    }\n\n    _createClass(RenderInStack, [{\n        key: \"render\",\n        value: function render() {\n            return false;\n        }\n    }]);\n\n    return RenderInStack;\n}(_react.Component);\n\nexports.default = RenderInStack;\n\n//# sourceURL=webpack:///./src/RenderInStack.js?");

/***/ }),

/***/ "./src/StackRenderer.js":
/*!******************************!*\
  !*** ./src/StackRenderer.js ***!
  \******************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _index = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar StackRenderer = function (_Component) {\n    _inherits(StackRenderer, _Component);\n\n    function StackRenderer(props) {\n        _classCallCheck(this, StackRenderer);\n\n        var _this = _possibleConstructorReturn(this, (StackRenderer.__proto__ || Object.getPrototypeOf(StackRenderer)).call(this, props));\n\n        _this.idHistory = [];\n        _this.currentIndex = 0;\n        if (props.currentId) {\n            _this.idHistory.push(props.currentId);\n            _this.currentIndex = 0;\n            _this.state = { currentId: props.currentId };\n        }\n        _this.scheduleRerender();\n        return _this;\n    }\n\n    _createClass(StackRenderer, [{\n        key: \"scheduleRerender\",\n        value: function scheduleRerender() {\n            var _this2 = this;\n\n            var poll = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;\n\n            if (this.rerenderTimer) {\n                return;\n            }\n            this.rerenderTimer = setTimeout(function () {\n                _this2.forceUpdate();\n                _this2.rerenderTimer = null;\n            }, poll);\n        }\n    }, {\n        key: \"clearHistory\",\n        value: function clearHistory() {\n            this.idHistory = this.idHistory.slice(-1);\n            this.currentIndex = 0;\n        }\n    }, {\n        key: \"componentWillReceiveProps\",\n        value: function componentWillReceiveProps(nextProps) {\n            var _this3 = this;\n\n            if (nextProps.currentId !== this.props.currentId) {\n                this.idHistory.push(nextProps.currentId);\n                this.currentIndex = this.idHistory.length - 1;\n                this.setState({ currentId: this.idHistory[this.currentIndex] }, function () {\n                    _this3.scheduleRerender();\n                });\n            }\n        }\n    }, {\n        key: \"goBack\",\n        value: function goBack() {\n            if (this.currentIndex > 0) {\n                this.currentIndex = this.currentIndex - 1;\n                this.setState({ currentId: this.idHistory[this.currentIndex] });\n            }\n        }\n    }, {\n        key: \"goForward\",\n        value: function goForward() {\n            if (this.currentIndex < this.idHistory.length - 1) {\n                this.currentIndex = this.currentIndex + 1;\n                this.setState({ currentId: this.idHistory[this.currentIndex] });\n            }\n        }\n    }, {\n        key: \"render\",\n        value: function render() {\n            var _props$instanceId = this.props.instanceId,\n                instanceId = _props$instanceId === undefined ? _index.DEFAULT_INSTANCE_ID : _props$instanceId,\n                currentId = this.state ? this.state.currentId : false,\n                childrenToRender = currentId && _index.globalContext[instanceId] && _index.globalContext[instanceId][currentId] ? _index.globalContext[instanceId][currentId] : false;\n\n            return childrenToRender;\n        }\n    }]);\n\n    return StackRenderer;\n}(_react.Component);\n\nexports.default = StackRenderer;\n\n//# sourceURL=webpack:///./src/StackRenderer.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n        value: true\n});\nexports.RenderInStack = exports.StackRenderer = exports.globalContext = exports.DEFAULT_INSTANCE_ID = undefined;\n\nvar _StackRenderer = __webpack_require__(/*! ./StackRenderer */ \"./src/StackRenderer.js\");\n\nvar _StackRenderer2 = _interopRequireDefault(_StackRenderer);\n\nvar _RenderInStack = __webpack_require__(/*! ./RenderInStack */ \"./src/RenderInStack.js\");\n\nvar _RenderInStack2 = _interopRequireDefault(_RenderInStack);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar DEFAULT_INSTANCE_ID = exports.DEFAULT_INSTANCE_ID = \"react-stacker/default-instance-id\",\n    globalContext = exports.globalContext = {};\n\nvar ReactStacker = {\n        DEFAULT_INSTANCE_ID: DEFAULT_INSTANCE_ID,\n        globalContext: globalContext,\n        StackRenderer: _StackRenderer2.default,\n        RenderInStack: _RenderInStack2.default\n};\n\nexports.default = ReactStacker;\nexports.StackRenderer = _StackRenderer2.default;\nexports.RenderInStack = _RenderInStack2.default;\n\n//# sourceURL=webpack:///./src/index.js?");
